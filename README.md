...
Chat GUI for [Beru](https://github.com/Omar-dar/beru). Bootstrapped with [Create React App](https://github.com/facebook/create-react-app).

## Quick start (Mac dev)

```bash
# Terminal 1 — backend
cd beru && python3 beru_api.py

# Terminal 2 — UI (uses http://localhost:8000 from .env.development)
cd beru-ui && npm start
```
